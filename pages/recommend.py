...
def recommend_page():
    ...
    if 'active_view' not in st.session_state:
        st.session_state.active_view = 'game'  # 'game' or 'feature'

    # Button layout
    col1, col2, col3 = st.columns([2, 1, 2])
    game_btn = col1.button("Recommend by Game", icon=":material/smart_toy:", use_container_width=True,type="primary")
    feature_btn = col3.button("Recommend by Features", icon=":material/view_list:", use_container_width=True,type="primary")
    ...
    if st.session_state.active_view == 'game':
        ...
        if col3.button("Recommend", key='recommend1',use_container_width=True,icon=":material/network_intelligence:",type="primary"):
