...
def load_models_and_data():
    """Load all necessary models and data files from local paths"""
    try:
        # Base paths
        models_path = 'models/'
        data_path = 'data/'
        ...
        knn_rec.load(
            model_path=os.path.join(models_path, 'game_recommender_knn_model.pkl'),
            data_path=os.path.join(models_path, 'game_data_processed.pkl')
        )
        ...
        cosine_rec.load(
            model_path=os.path.join(models_path, 'game_recommender_knn_model.pkl'),
            data_path=os.path.join(models_path, 'game_data_processed.pkl'),
            similarity_matrix_path=os.path.join(models_path, 'cosine_sim_matrix.pkl')
        )
        
        # Load additional components
        scaler = joblib.load(os.path.join(models_path, 'minmax_scaler.pkl'))
        one_hot_columns = joblib.load(os.path.join(models_path, 'one_hot_columns.pkl'))
        game_names = joblib.load(os.path.join(models_path, 'game_names.pkl'))
